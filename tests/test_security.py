...
class TestGDPRCompliance:
    ...
    async def test_get_user_data_summary(self):
        ...
        service.user_manager.get_user_birth_data = AsyncMock(return_value={
            "birth_date": "1990-05-15",
            "birth_time": "14:30"
        })
    ...
    async def test_export_user_data(self):
        ...
        service.get_user_data_summary = AsyncMock(return_value={
    ...
    async def test_request_data_deletion(self):
        ...
        service.user_manager.request_data_deletion = AsyncMock(return_value="verification_code")
