...
class TestHoroscopeGenerator:
    ...
    def test_different_zodiac_signs(self):
        ...
        all_signs = [
            YandexZodiacSign.ARIES, YandexZodiacSign.TAURUS, YandexZodiacSign.GEMINI,
            YandexZodiacSign.CANCER, YandexZodiacSign.LEO, YandexZodiacSign.VIRGO,
            YandexZodiacSign.LIBRA, YandexZodiacSign.SCORPIO, YandexZodiacSign.SAGITTARIUS,
            YandexZodiacSign.CAPRICORN, YandexZodiacSign.AQUARIUS, YandexZodiacSign.PISCES
        ]
    ...
    def test_moon_phase_influence(self):
        ...
        moon_phases = [h['astrological_influences']['moon_phase']['phase_name'] 
                      for h in horoscopes]
    ...
    def test_advice_generation(self):
        ...
        sign_keywords = self.generator.sign_characteristics[YandexZodiacSign.LIBRA]['keywords']
    ...
    def test_deterministic_behavior(self):
        ...
        assert horoscope1['energy_level']['level'] == horoscope2['energy_level']['level']
        
        # Астрологические влияния должны быть одинаковыми
        assert horoscope1['astrological_influences']['moon_phase'] == horoscope2['astrological_influences']['moon_phase']