...
from app.services.dialog_flow_manager import (
    DialogFlowManager, 
    DialogFlow, 
    DialogState
)
...
class TestDialogFlowManager:
    ...
    def test_intent_processing_in_flow(self, dialog_manager, sample_flow, processed_request):
    ...
    def test_state_transitions(self, dialog_manager):
        ...
        next_state = dialog_manager._determine_next_state(flow, YandexIntent.HOROSCOPE, {})
        assert next_state == DialogState.COLLECTING_BIRTH_DATA
    ...
    def test_transition_conditions(self, dialog_manager):
        ...
        flow_with_data = DialogFlow("test", DialogState.COLLECTING_BIRTH_DATA, {
...
class TestConversationManager:
    ...
    def test_recent_intents(self, conversation_context):
        ...
        intents = [YandexIntent.HOROSCOPE, YandexIntent.COMPATIBILITY, YandexIntent.ADVICE]
    ...
    def test_preferred_topics(self, conversation_context):
        ...
        for _ in range(2):
            conversation_context.add_interaction(YandexIntent.COMPATIBILITY, {}, "response")
    ...
    @pytest.mark.asyncio
    async def test_conversation_processing(self, conversation_manager, processed_request):
        ...
        dialog_state, response_context = await conversation_manager.process_conversation(
...
class TestIntegration:
    ...
    async def test_personalization_progression(self, managers):
        ...
        for i, intent in enumerate(intents):
            ...
            personalization_level = context.get("interaction_stats", {}).get("personalization_level", 0)
