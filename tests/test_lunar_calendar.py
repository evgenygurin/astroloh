...
class TestLunarCalendar:
    ...
    def test_moon_phase_activities(self):
        ...
        expected_phases = ["Новолуние", "Растущая Луна", "Полнолуние", "Убывающая Луна"]
        expected_activities = ["business", "health", "relationships", "creativity", "spiritual"]
    ...
    def test_key_lunar_dates(self):
        ...
        expected_keys = ['new_moon', 'full_moon', 'first_quarter', 'last_quarter']
    ...
    def test_monthly_advice(self):
        ...
        assert "внутреннего развития" in advice['general'] or "планирования" in advice['general']
    
    def test_lunar_recommendations_by_activity(self):
        """Тест рекомендаций по типу деятельности."""
        test_date = datetime(2023, 8, 10, 15, 30)
        activity_types = ["business", "health", "relationships", "creativity", "spiritual"]
    ...
    def test_favorability_scoring(self):
        ...
        activities = ["business", "health", "relationships", "creativity", "spiritual"]
        scores = []
    ...
    def test_seasonal_influence(self):
        ...
        for test_date, expected_season in seasons_data:
            ...
            if 'astrological_influences' in lunar_info:
                season_influence = lunar_info['astrological_influences'].get('season_influence', {})
