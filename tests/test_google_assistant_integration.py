...
class TestGoogleAssistantWebhook:
    ...
    def test_google_actions_webhook(self, mock_user_manager, mock_handler):
        ...
        google_request = {
            "user": {"userId": "google_user_123", "locale": "ru-RU"},
            "conversation": {"conversationId": "conv_456", "type": "NEW"},
            "inputs": [
                {
                    "intent": "actions.intent.MAIN",
                    "rawInputs": [{"query": "Talk to Astrologer"}],
                }
            ],
            "device": {},
            "surface": {
            ...
            "inputs": [
                {
                    ...
                    "rawInputs": [{"query": "Расскажи гороскоп на завтра"}],
                }
            ],
    ...
    def test_convert_dialogflow_to_universal(self):
        ...
        dialogflow_request = {
            "queryResult": {
                ...
                "languageCode": "ru",
                "parameters": {"sign1": "Лев", "sign2": "Рыбы"},
            },
        ...
        assert (
            universal_request.user_context["dialogflow"]["intent_name"]
