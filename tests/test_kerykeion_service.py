...
class TestKerykeionServiceWithKerykeion:
    ...
    def test_create_astrological_subject_success(
    ...
    def test_create_astrological_subject_with_different_house_systems(
        self, service, sample_birth_data
    ):
    ...
    def test_create_astrological_subject_with_different_zodiac_types(
        self, service, sample_birth_data
    ):
    ...
    def test_create_astrological_subject_with_invalid_timezone(
        self, service, sample_birth_data
    ):
    ...
    def test_get_full_natal_chart_data_success(
        self, service, sample_birth_data
    ):
    ...
    def test_get_full_natal_chart_data_includes_arabic_parts(
        self, service, sample_birth_data
    ):
    ...
    def test_get_full_natal_chart_data_includes_chart_analysis(
        self, service, sample_birth_data
    ):
...
class TestKerykeionServiceWithoutKerykeion:
    ...
    def service_without_kerykeion(self):
        ...
        with patch(
            "app.services.kerykeion_service.KERYKEION_AVAILABLE", False
        ):
            service = KerykeionService()
        ...
        for lat, lng in extreme_coords:
            ...
            try:
                ...
                assert (
                    ...
                    or "latitude" in str(e).lower()
                    or "longitude" in str(e).lower()
                )
