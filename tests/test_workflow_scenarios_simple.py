...
class TestSimpleWorkflowScenarios:
    ...
    async def test_greeting_workflow(self):
        ...
        with patch.object(self.dialog_handler.session_manager, 'get_user_context') as mock_get_context, \
             patch.object(self.dialog_handler.session_manager, 'is_new_session') as mock_is_new, \
             patch.object(self.dialog_handler.session_manager, 'update_user_context') as mock_update, \
             patch.object(self.dialog_handler.conversation_manager, 'process_conversation') as mock_conversation:
    ...
    async def test_horoscope_request_workflow(self):
        ...
        with patch.object(self.dialog_handler.session_manager, 'get_user_context') as mock_get_context, \
             patch.object(self.dialog_handler.session_manager, 'set_awaiting_data') as mock_set_awaiting, \
             patch.object(self.dialog_handler.session_manager, 'is_new_session') as mock_is_new, \
             patch.object(self.dialog_handler.conversation_manager, 'process_conversation') as mock_conversation, \
             patch.object(self.dialog_handler.response_formatter, 'format_horoscope_request_response') as mock_format:
    ...
    async def test_help_workflow(self):
        ...
        with patch.object(self.dialog_handler.session_manager, 'get_user_context') as mock_get_context, \
             patch.object(self.dialog_handler.session_manager, 'is_new_session') as mock_is_new, \
             patch.object(self.dialog_handler.conversation_manager, 'process_conversation') as mock_conversation, \
             patch.object(self.dialog_handler.response_formatter, 'format_help_response') as mock_format:
