...
HAS_ACCURATE_ASTRONOMY = (
    KERYKEION_AVAILABLE or SWISSEPH_AVAILABLE or SKYFIELD_AVAILABLE
)
...
class TestMoonPhaseAccuracy:
    ...
    @pytest.mark.skipif(
        not HAS_ACCURATE_ASTRONOMY,
        reason="Accurate astronomical library not available",
    )
