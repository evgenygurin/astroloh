...
class TestErrorRecoveryService:
    ...
    async def test_handle_error_with_clarification(self):
        ...
        with patch('app.services.error_recovery.ResponseFormatter') as mock_formatter:
            ...
            mock_formatter.return_value.format_clarification_response.return_value = mock_response
            
            result = await self.error_recovery.handle_error(error, request, mock_context)
    ...
    async def test_handle_error_with_fallback(self):
        ...
        with patch('app.services.error_recovery.ResponseFormatter') as mock_formatter:
            mock_response = MagicMock()
            mock_formatter.return_value.format_fallback_response.return_value = mock_response
    ...
    def test_generate_error_suggestions_personalized(self):
        ...
        request = self.create_mock_request("мой гороскоп")
        mock_context = MagicMock()
        mock_context.preferences = {"zodiac_sign": "leo", "favorite_topic": "love"}
