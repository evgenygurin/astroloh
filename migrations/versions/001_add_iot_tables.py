...
def upgrade() -> None:
    ...
    op.create_index('idx_iot_devices_device_type', 'iot_devices', ['device_type'])
    op.create_index('idx_iot_devices_status', 'iot_devices', ['status'])
    op.create_index('idx_home_automations_user_id', 'home_automations', ['user_id'])
    op.create_index('idx_home_automations_trigger_type', 'home_automations', ['trigger_type'])
    ...
    op.create_index('idx_wearable_data_timestamp', 'wearable_data', ['timestamp'])
