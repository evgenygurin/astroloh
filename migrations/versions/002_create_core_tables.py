...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('current_state', sa.String(length=50), nullable=False, default='initial'),
    ...
    op.create_table(
        ...
        sa.Column('communication_style', sa.String(length=20), nullable=True, default='balanced'),
        sa.Column('complexity_level', sa.String(length=20), nullable=True, default='intermediate'),
        ...
        sa.Column('language_preference', sa.String(length=10), nullable=True, default='ru'),
        sa.Column('content_length_preference', sa.String(length=20), nullable=True, default='medium'),
        sa.Column('detail_level', sa.String(length=20), nullable=True, default='standard'),
    ...
    op.create_index('idx_horoscope_requests_user_id', 'horoscope_requests', ['user_id'])
    op.create_index('idx_horoscope_requests_type', 'horoscope_requests', ['request_type'])
