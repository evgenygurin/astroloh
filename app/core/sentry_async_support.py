        ...
        async def wrapper(*args, **kwargs):
            ...
            with start_span(
                ...
                if current_task:
                    ...
                    span.set_tag("asyncio.task_cancelled", current_task.cancelled())
...
async def trace_concurrent_operations(
    ...
    **group_metadata
    ...
    with start_span(
        op="async.concurrent",
        description=f"Concurrent: {operation_group}"
    ) as span:
...
async def capture_async_exception_context(
    ...
    """
    with sentry_sdk.configure_scope() as scope:
        scope.set_context("async_exception", {
            ...
            async with trace_async_context(
                ...
                **task_metadata
                ...
                try:
                    ...
                    await capture_async_exception_context(e, {
                        "task_name": name,
                        "task_type": "background",
                        **task_metadata
                    })
