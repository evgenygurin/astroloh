...
async def confirm_data_deletion(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to confirm deletion: {str(e)}")
...
async def restrict_processing(
    ...
    try:
        ...
        if not success:
            raise HTTPException(status_code=500, detail="Failed to update processing restriction")
        ...
        raise HTTPException(status_code=500, detail=f"Failed to restrict processing: {str(e)}")
