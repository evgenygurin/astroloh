...
async def get_personalized_horoscope(
    ...
    try:
        ...
        logger.error(f"Error generating personalized horoscope for user {user_id}: {str(e)}")
        raise HTTPException(status_code=500, detail="Internal server error")
...
async def get_user_analytics(
    ...
    try:
        ...
        engagement_analysis = await engagement_optimizer.optimize_user_engagement(user.id)
...
async def get_seasonal_recommendations(
    ...
    try:
        ...
        logger.error(f"Error getting seasonal recommendations for user {user_id}: {str(e)}")
        raise HTTPException(status_code=500, detail="Internal server error")
...
async def assign_ab_test(
    ...
    try:
        ...
        test_parameters = ab_test_manager._get_test_parameters(test_name, assigned_group)
