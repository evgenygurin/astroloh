...
class MultiPlatformFormatter(ResponseFormatter):
    ...
    def _yandex_to_universal(
        ...
        universal_response = UniversalResponse(
            ...
            end_session=yandex_response.end_session if hasattr(yandex_response, 'end_session') else False,
            should_listen=not yandex_response.end_session if hasattr(yandex_response, 'end_session') else True,
        )
