...
class NatalChartCalculator:
    ...
    def __init__(self):
        ...
        self.planet_sign_interpretations = {
            "Sun": {
                ...
                "keywords": ["индивидуальность", "творчество", "лидерство", "самовыражение"]
            },
            "Moon": {
            ...
            "Mercury": {
                ...
                "keywords": ["коммуникация", "логика", "анализ", "любознательность"]
            },
            "Venus": {
                "description": "Любовь, красота, ценности, отношения",
                "keywords": ["любовь", "гармония", "искусство", "привлекательность"]
            },
            "Mars": {
                "description": "Энергия, действие, желания, агрессия",
                "keywords": ["энергия", "инициатива", "страсть", "соперничество"]
            },
            "Jupiter": {
                "description": "Рост, расширение, мудрость, удача",
                "keywords": ["оптимизм", "философия", "путешествия", "изобилие"]
            },
            "Saturn": {
                "description": "Дисциплина, ограничения, ответственность",
                "keywords": ["дисциплина", "терпение", "структура", "мудрость"]
            },
            "Uranus": {
                "description": "Оригинальность, инновации, свобода",
                "keywords": ["независимость", "инновации", "бунтарство", "интуиция"]
            },
            "Neptune": {
                "description": "Духовность, иллюзии, творчество",
                "keywords": ["мистицизм", "сострадание", "творчество", "иллюзии"]
            },
            "Pluto": {
                "description": "Трансформация, власть, регенерация",
                "keywords": ["трансформация", "сила воли", "глубина", "возрождение"]
            }
        }
        ...
        self.house_meanings = {
            ...
            3: {
                ...
                "keywords": ["общение", "обучение", "братья/сестры", "поездки"]
            },
            4: {
            ...
            7: {
                ...
                "keywords": ["партнерство", "брак", "сотрудничество", "контракты"]
            },
            8: {
                "name": "Дом трансформации",
                "description": "Смерть и возрождение, общие ресурсы, оккультизм",
                "keywords": ["трансформация", "тайны", "общие ресурсы", "кризисы"]
            },
            9: {
                "name": "Дом философии",
                "description": "Высшее образование, философия, религия, дальние путешествия",
                "keywords": ["философия", "религия", "путешествия", "высшее образование"]
            },
            10: {
                "name": "Дом карьеры",
    ...
    def _interpret_personality(self, planets: Dict[str, Dict[str, Any]]) -> Dict[str, str]:
        ...
        personality = {
            ...
            "general_description": self._get_personality_description(sun_sign, moon_sign)
        }
    ...
    def _interpret_relationships(
        ...
        relationships = {
            ...
            "compatibility_advice": self._get_relationship_advice(venus_sign, mars_sign, venus_mars_aspect)
        }
    ...
    def _get_relationship_advice(
        ...
        venus_sign: str, 
        mars_sign: str, 
        venus_mars_aspect: Optional[str]
    ) -> str:
    ...
    def _calculate_chart_signature(self, planets: Dict[str, Dict[str, Any]]) -> Dict[str, str]:
    ...
    def _calculate_dominant_elements(self, planets: Dict[str, Dict[str, Any]]) -> Dict[str, int]:
    ...
    def _determine_chart_shape(self, planets: Dict[str, Dict[str, Any]]) -> Dict[str, str]:
