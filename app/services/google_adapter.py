...
class GoogleAssistantAdapter(PlatformAdapter):
    ...
    def _from_dialogflow_request(
        self, dialogflow_data: Dict[str, Any]
    ) -> UniversalRequest:
        ...
        user_context = {
            "dialogflow": {
                ...
                "intent_detection_confidence": query_result.get(
        ...
        try:
            ...
            if universal_response.image_url:
                basic_card = GoogleBasicCard(
                    title="Astroloh",
                    formatted_text=universal_response.image_caption
                    or universal_response.text,
