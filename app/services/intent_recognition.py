...
class IntentRecognizer:
    ...
    def __init__(self) -> None:
        ...
        self.intent_patterns = {
            ...
            YandexIntent.SIGN_DESCRIPTION: [
                r"расскажи.*про.*мой.*знак.*зодиака",
                r"расскажи.*о.*моем.*знаке",
                r"опиши.*мой.*знак",
                r"характеристика.*моего.*знака",
                r"мой.*знак.*зодиака",
                r"что.*значит.*мой.*знак",
                r"особенности.*моего.*знака",
                r"черты.*моего.*знака",
                r"какой.*я.*по.*гороскопу",
                r"мой.*астрологический.*профиль",
            ],
            YandexIntent.PLANET_IN_SIGN: [
                r"что.*означает.*солнце.*в.*овне",
                r"солнце.*в.*тельце.*значение",
                r"луна.*в.*раке.*характеристика",
                r"меркурий.*в.*близнецах",
                r"венера.*в.*весах.*что.*значит",
                r"марс.*в.*скорпионе.*описание",
                r"юпитер.*в.*стрельце.*влияние",
                r"сатурн.*в.*козероге.*означает",
                r"планета.*в.*знаке.*значение",
                r"влияние.*планеты.*в.*знаке",
                r"расскажи.*про.*планету.*в.*знаке",
                r"что.*дает.*планета.*в.*знаке",
            ],
            YandexIntent.HOUSE_CHARACTERISTICS: [
                r"характеристика.*луны.*в.*раке",
                r"солнце.*в.*четвертом.*доме",
                r"планеты.*в.*домах.*значение",
                r"что.*означает.*планета.*в.*доме",
                r"влияние.*дома.*на.*планету",
                r"дом.*гороскопа.*описание",
                r"астрологический.*дом.*характеристика",
                r"планета.*попала.*в.*дом",
                r"расскажи.*про.*дом.*гороскопа",
                r"значение.*астрологических.*домов",
            ],
            YandexIntent.ENHANCED_COMPATIBILITY: [
                r"совместимость.*льва.*и.*стрельца",
                r"совместимость.*знаков.*зодиака",
                r"подходят.*ли.*знаки",
                r"астрологическая.*совместимость",
                r"совместимость.*по.*гороскопу",
                r"хорошая.*ли.*пара.*по.*звездам",
                r"отношения.*знаков.*зодиака",
                r"любовная.*совместимость.*знаков",
                r"как.*уживаются.*знаки",
                r"гороскоп.*совместимости",
                r"детальная.*совместимость",
                r"расширенный.*анализ.*совместимости",
            ],
            YandexIntent.RETROGRADE_INFLUENCE: [
                r"влияние.*меркурия.*в.*ретрограде",
                r"меркурий.*ретроградный.*что.*значит",
                r"ретроградные.*планеты.*влияние",
                r"когда.*планеты.*идут.*назад",
                r"обратное.*движение.*планет",
                r"ретроград.*планеты.*означает",
                r"планета.*в.*попятном.*движении",
                r"что.*происходит.*при.*ретрограде",
                r"как.*влияет.*ретроградный.*меркурий",
                r"ретроградная.*венера.*влияние",
                r"обратный.*ход.*планеты",
            ],
            # Enhanced AI Consultation Intents
            YandexIntent.AI_NATAL_INTERPRETATION: [
                r"интерпретация.*натальной.*карты",
                r"расшифруй.*натальную.*карту",
                r"объясни.*мою.*карту",
                r"подробно.*о.*карте",
                r"анализ.*натальной.*карты",
                r"что.*означает.*моя.*карта",
                r"детальная.*интерпретация",
                r"разбор.*натальной.*карты",
                r"профессиональная.*интерпретация",
                r"глубокий.*анализ.*карты",
                r"ии.*натальная.*карта",
                r"искусственный.*интеллект.*карта",
                r"умная.*интерпретация",
            ],
            YandexIntent.AI_CAREER_CONSULTATION: [
                r"карьерный.*совет",
                r"консультация.*по.*карьере",
                r"профессиональная.*консультация",
                r"работа.*и.*звезды",
                r"карьера.*по.*звездам",
                r"профессиональное.*призвание",
                r"совет.*по.*работе",
                r"карьерные.*возможности",
                r"астролог.*по.*карьере",
                r"ии.*карьера",
                r"умные.*советы.*работа",
                r"искусственный.*интеллект.*карьера",
                r"что.*звезды.*говорят.*работе",
                r"астрологический.*карьерный.*совет",
            ],
            YandexIntent.AI_LOVE_CONSULTATION: [
                r"любовная.*консультация",
                r"совет.*по.*любви",
                r"отношения.*и.*звезды",
                r"любовный.*гороскоп",
                r"романтический.*совет",
                r"астролог.*по.*любви",
                r"сердечные.*дела",
                r"любовные.*перспективы",
                r"ии.*любовь",
                r"умные.*советы.*любовь",
                r"искусственный.*интеллект.*любовь",
                r"что.*звезды.*говорят.*любви",
                r"астрологическая.*любовная.*консультация",
            ],
            YandexIntent.AI_HEALTH_CONSULTATION: [
                r"здоровье.*и.*звезды",
                r"медицинская.*астрология",
                r"совет.*по.*здоровью",
                r"астрологическое.*здоровье",
                r"что.*звезды.*говорят.*здоровье",
                r"консультация.*по.*здоровью",
                r"здоровье.*по.*звездам",
                r"астролог.*по.*здоровью",
                r"ии.*здоровье",
                r"умные.*советы.*здоровье",
                r"искусственный.*интеллект.*здоровье",
                r"астрологический.*совет.*здоровье",
            ],
            YandexIntent.AI_FINANCIAL_CONSULTATION: [
                r"финансовая.*консультация",
                r"деньги.*и.*звезды",
                r"совет.*по.*финансам",
                r"астрологические.*финансы",
                r"денежный.*гороскоп",
                r"финансовые.*возможности",
                r"астролог.*по.*деньгам",
                r"финансовый.*прогноз",
                r"ии.*финансы",
                r"умные.*советы.*деньги",
                r"искусственный.*интеллект.*финансы",
                r"что.*звезды.*говорят.*деньгах",
                r"астрологический.*финансовый.*совет",
            ],
            YandexIntent.AI_SPIRITUAL_CONSULTATION: [
                r"духовная.*консультация",
                r"духовное.*развитие",
                r"кармические.*задачи",
                r"жизненные.*уроки",
                r"духовный.*путь",
                r"эзотерическая.*консультация",
                r"духовная.*астрология",
                r"кармическая.*астрология",
                r"ии.*духовность",
                r"умные.*советы.*духовность",
                r"искусственный.*интеллект.*духовность",
                r"астрологический.*духовный.*совет",
                r"что.*звезды.*говорят.*душе",
            ],
            YandexIntent.AI_ENHANCED_COMPATIBILITY: [
                r"улучшенная.*совместимость",
                r"детальная.*совместимость",
                r"глубокий.*анализ.*совместимости",
                r"профессиональная.*совместимость",
                r"синастрия.*с.*ии",
                r"умная.*совместимость",
                r"ии.*совместимость",
                r"искусственный.*интеллект.*совместимость",
                r"продвинутый.*анализ.*отношений",
                r"детальный.*анализ.*пары",
                r"углубленная.*совместимость",
                r"современная.*синастрия",
            ],
            YandexIntent.AI_TRANSIT_FORECAST: [
                r"прогноз.*транзитов",
                r"транзитный.*прогноз",
                r"ии.*транзиты",
                r"умный.*прогноз.*транзиты",
                r"искусственный.*интеллект.*транзиты",
                r"детальный.*прогноз.*транзиты",
                r"современный.*транзитный.*прогноз",
                r"продвинутый.*анализ.*транзитов",
                r"глубокий.*прогноз.*влияний",
                r"что.*планеты.*готовят.*подробно",
                r"профессиональный.*транзитный.*анализ",
            ],
            YandexIntent.AI_SERVICE_STATUS: [
                r"статус.*ии",
                r"статус.*искусственного.*интеллекта",
                r"работает.*ли.*ии",
                r"доступность.*ии",
                r"проверь.*ии",
                r"что.*умеет.*ии",
