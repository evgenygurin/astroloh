    ...
    def __init__(self) -> None:
        ...
        self.intent_patterns = {
            ...
            YandexIntent.TRANSITS: [
                ...
                r"что происходит в небе",
                r"какие транзиты",
                r"планетные влияния",
                r"небесная обстановка",
                r"астрологический фон",
                r"влияние сегодня",
                r"транзитные аспекты",
                r"актуальные транзиты",
            ],
            YandexIntent.PROGRESSIONS: [
                ...
                r"развитие карты",
                r"эволюция личности",
                r"прогрессивные аспекты",
                r"что показывают прогрессии",
                r"прогрессивная карта",
                r"внутреннее развитие",
                r"личностный рост",
                r"эволюция души",
                r"прогрессивные планеты",
                r"символическое развитие",
            ],
            YandexIntent.SOLAR_RETURN: [
                r"соляр",
                r"солнечное возвращение",
                r"год карта",
                r"карта года",
                r"соляр на год",
                r"годичная карта",
                r"солнечный год",
                r"что готовит год",
                r"карта на день рождения",
                r"астрология года",
                r"солнечный цикл",
                r"мой соляр",
                r"расскажи про соляр",
            ],
            YandexIntent.LUNAR_RETURN: [
                r"лунар",
                r"лунное возвращение",
                r"месячная карта",
                r"карта месяца",
                r"лунный цикл",
                r"что готовит месяц",
