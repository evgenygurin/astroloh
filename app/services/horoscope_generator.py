...
class HoroscopeGenerator:
    ...
    def __init__(self):
        ...
        self.sign_characteristics = {
            YandexZodiacSign.ARIES: {
                ...
                "quality": "cardinal",
                "ruling_planet": "Mars",
                "keywords": ["энергия", "инициатива", "лидерство", "импульсивность"],
            ...
            YandexZodiacSign.TAURUS: {
                ...
                "quality": "fixed", 
                "ruling_planet": "Venus",
                "keywords": ["стабильность", "упорство", "красота", "материальность"],
            ...
            YandexZodiacSign.GEMINI: {
                ...
                "keywords": ["общение", "любознательность", "гибкость", "многозадачность"],
            ...
            YandexZodiacSign.LEO: {
                ...
                "quality": "fixed",
                "ruling_planet": "Sun",
                "keywords": ["творчество", "гордость", "великодушие", "драматизм"],
            ...
            YandexZodiacSign.VIRGO: {
                ...
                "quality": "mutable",
                "ruling_planet": "Mercury",
                "keywords": ["аналитичность", "практичность", "перфекционизм", "служение"],
            ...
            YandexZodiacSign.LIBRA: {
                ...
                "quality": "cardinal", 
                "ruling_planet": "Venus",
                "keywords": ["гармония", "справедливость", "партнерство", "красота"],
            ...
            YandexZodiacSign.SAGITTARIUS: {
                ...
                "keywords": ["философия", "путешествия", "оптимизм", "свобода"],
            ...
            YandexZodiacSign.CAPRICORN: {
                ...
                "keywords": ["амбиции", "дисциплина", "ответственность", "традиции"],
            ...
            YandexZodiacSign.AQUARIUS: {
                ...
                "keywords": ["инновации", "независимость", "гуманизм", "оригинальность"],
            ...
            YandexZodiacSign.PISCES: {
                ...
                "keywords": ["интуиция", "сострадание", "творчество", "мистичность"],
    ...
    def _get_seasonal_influence(self, target_date: datetime) -> Dict[str, str]:
        ...
        if 3 <= month <= 5:
            ...
            return {"season": "лето", "influence": "активность и самовыражение"}
        elif 9 <= month <= 11:
            return {"season": "осень", "influence": "сбор урожая и рефлексия"}
        else:
            return {"season": "зима", "influence": "внутреннее развитие и планирование"}
    ...
    def _get_moon_sphere_bonus(self, sphere: str, moon_phase: str) -> float:
        ...
        moon_sphere_bonuses = {
            "Новолуние": {"career": 1, "health": 0.5, "finances": 0.5, "love": 0},
            "Растущая Луна": {"love": 1, "career": 0.5, "finances": 1, "health": 0.5},
            "Полнолуние": {"love": 1, "health": -0.5, "career": 0.5, "finances": -0.5},
            "Убывающая Луна": {"health": 1, "finances": 0.5, "love": 0, "career": 0}
        }
    ...
    def _get_sphere_advice(self, sphere: str, rating: int, zodiac_sign: YandexZodiacSign) -> str:
