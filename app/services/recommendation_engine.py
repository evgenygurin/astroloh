...
class CollaborativeFiltering:
    ...
    async def find_similar_users(
        ...
        for other_user, other_prefs in other_users:
            similarity = self._calculate_user_similarity(
                current_user, current_prefs,
                other_user, other_prefs
            )
    ...
    def _calculate_user_similarity(
        self,
        user1: User, prefs1: Optional[UserPreference],
        user2: User, prefs2: Optional[UserPreference]
    ) -> float:
    ...
    async def _get_current_transits(self, user: User) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "transits": self.astrology.calculate_transits(natal_chart, current_planets)
            }
        except Exception:
            return {}
...
class UserClusteringManager:
    ...
    def _encode_zodiac_sign(self, zodiac_sign: Optional[str]) -> List[float]:
        ...
        return zodiac_mapping.get(zodiac_sign.lower() if zodiac_sign else "", [0, 0, 0, 0])
