...
class SimpleClaudeClient:
    ...
    def __init__(self):
        ...
        if not api_key or api_key.strip() == "":
            print(
                "⚠️  Error: ANTHROPIC_API_KEY not found or empty in environment."
            )
        ...
        if not api_key.startswith("sk-ant-") or len(api_key) < 50:
            ...
            print(
                "   Anthropic API keys should start with 'sk-ant-' and be at least 50 characters long."
            )
            ...
            try:
                ...
                if query.lower() == "quit":
                    ...
                    for i, msg in enumerate(self.conversation_history, 1):
                        ...
                        print(
                            f"{i}. {role_emoji} {msg['role']}: {content_preview}..."
                        )
                    continue
                elif not query:
                    continue
